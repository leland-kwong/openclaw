...
type GatewayPresentationScope = { readonly key: number; displayUser: AuthenticatedUser | null };
...
export function gatewayPresentationScope(
  ...
  if (
    ...
    const next = { scope: { key: ++nextScopeKey, displayUser: user ?? null }, revision, userId };
